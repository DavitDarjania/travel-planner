...
import { add_data, add_favourites, modal_open, remove_favourites } from '@/features/cardSlice'
...
const Modal = ({ onClose }: ITestModal) => {
    ...
    const {
        ...
        timezones,
        area
    }: ICardContent | {} = useAppSelector((state: RootState) => state.data_update.data)

    return (
        <>
            <div className="fixed w-full h-full inset-0 bg-black opacity-25"
                onClick={() => {
                ...
                <div className="p-6" >
                    ...
                    <div className="flex space-x-3 mb-6">
                        <Button
                            ...
                            onClick={() => {
                                dispatch(favourite_cards.includes(common.toLowerCase()) ?
                                    remove_favourites(common.toLowerCase())
                                    : add_favourites(common.toLowerCase())
                                )
                            }}

                            variant={favourite_cards.includes(common.toLowerCase()) ? "modal_favourited" : "modal_favourite"}
                            content={<>
                                <svg
                                ...
                                <span>{ favourite_cards.includes(common.toLowerCase()) ? <>Favorited</> : <>Added to Favorites</>}</span>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">{currencies[0].name} {currencies[0].symbol}</p>
                                </div>
                            </div>
