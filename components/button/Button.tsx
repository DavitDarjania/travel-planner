...
const Button: React.FC<TButton> = ({
    ...
    const buttonClass = clsx(
        'font-medium',
        {
            ...
            "p-2 rounded-full transition-all duration-200 bg-white bg-opacity-80 text-gray-600 hover:bg-red-500 hover:text-white": variant == 'favourites',
            "p-2 rounded-full bg-white bg-opacity-80 text-gray-600 hover:bg-blue-500 hover:text-white transition-all duration-200": variant == 'add',
